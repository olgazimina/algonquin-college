...
public class ComplexCalculatorLauncher {
    ...
    public static void main(String[] args) {
        ...
        } while (input.next().charAt(0) != 'Q'); // until user enters [Q]
    ...
    private static Complex getComplexNumber() {
        // variable [choice] will take the number of the user input choice
        choice = ComplexCalculatorLauncher.displayTypeInputMenu();
        input.nextLine();  // Remove CRLF from input buffer
        
        // detect which string to show
        System.out.println("Enter a " + String.valueOf((counter++ % 2) + 1) + "complex number");
